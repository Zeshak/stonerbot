...
namespace BotOfStone
{
  public class Plugin : MonoBehaviour
  {
    ...
    public static void init()
    {
      ...
      Log.newLog();
      Log.module = "BOT";
      UnityEngine.Object.Destroy((UnityEngine.Object) gameObject.GetComponent("Plugin"));
      foreach (Plugin plugin in gameObject.GetComponents<Plugin>())
      {
        Log.debug("destroying old component: " + plugin.ToString());
        UnityEngine.Object.Destroy((UnityEngine.Object) plugin);
      }
