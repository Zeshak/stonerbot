namespace bnet.protocol.attribute
{
    ...
    public sealed class AttributeFilter : GeneratedMessageLite<AttributeFilter, Builder>
    {
        ...
        public override void PrintTo(TextWriter writer)
        {
            ...
            GeneratedMessageLite<AttributeFilter, Builder>.PrintField<bnet.protocol.attribute.Attribute>("attribute", this.attribute_, writer);
        }
        ...
        public override void WriteTo(ICodedOutputStream output)
        {
            ...
            {
                output.WriteMessageArray<bnet.protocol.attribute.Attribute>(2, strArray[0], this.attribute_);
            }
        }
        ...
        public sealed class Builder : GeneratedBuilderLite<AttributeFilter, AttributeFilter.Builder>
        {
            ...
            public AttributeFilter.Builder AddAttribute(bnet.protocol.attribute.Attribute value)
            {
            ...
            public AttributeFilter.Builder AddAttribute(bnet.protocol.attribute.Attribute.Builder builderForValue)
            {
            ...
            public AttributeFilter.Builder AddRangeAttribute(IEnumerable<bnet.protocol.attribute.Attribute> values)
            {
                this.PrepareBuilder();
            ...
            public AttributeFilter.Builder SetAttribute(int index, bnet.protocol.attribute.Attribute value)
            {
                Google.ProtocolBuffers.ThrowHelper.ThrowIfNull(value, "value");
                this.PrepareBuilder();
            ...
            public AttributeFilter.Builder SetAttribute(int index, bnet.protocol.attribute.Attribute.Builder builderForValue)
            {
                Google.ProtocolBuffers.ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
                this.PrepareBuilder();
