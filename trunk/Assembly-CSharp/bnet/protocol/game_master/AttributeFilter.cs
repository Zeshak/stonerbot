namespace bnet.protocol.game_master
{
    ...
    public sealed class AttributeFilter : GeneratedMessageLite<AttributeFilter, Builder>
    {
        ...
        public override void PrintTo(TextWriter writer)
        {
            ...
            GeneratedMessageLite<AttributeFilter, Builder>.PrintField<bnet.protocol.game_master.Attribute>("attribute", this.attribute_, writer);
        }
        ...
        public sealed class Builder : GeneratedBuilderLite<AttributeFilter, AttributeFilter.Builder>
        {
            ...
            public AttributeFilter.Builder AddAttribute(bnet.protocol.game_master.Attribute value)
            {
            ...
            public AttributeFilter.Builder AddAttribute(bnet.protocol.game_master.Attribute.Builder builderForValue)
            {
            ...
            public AttributeFilter.Builder AddRangeAttribute(IEnumerable<bnet.protocol.game_master.Attribute> values)
            {
                this.PrepareBuilder();
            ...
            public AttributeFilter.Builder SetAttribute(int index, bnet.protocol.game_master.Attribute value)
            {
                Google.ProtocolBuffers.ThrowHelper.ThrowIfNull(value, "value");
                this.PrepareBuilder();
            ...
            public AttributeFilter.Builder SetAttribute(int index, bnet.protocol.game_master.Attribute.Builder builderForValue)
            {
                Google.ProtocolBuffers.ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
                this.PrepareBuilder();
