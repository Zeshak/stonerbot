namespace bnet.protocol.notification
{
    ...
    public sealed class Variant : GeneratedMessageLite<bnet.protocol.notification.Variant, Builder>
    {
        ...
        private static readonly bnet.protocol.notification.Variant defaultInstance = new bnet.protocol.notification.Variant().MakeReadOnly();
        ...
        public static Builder CreateBuilder(bnet.protocol.notification.Variant prototype)
        {
        ...
        {
            bnet.protocol.notification.Variant variant = obj as bnet.protocol.notification.Variant;
            if (variant == null)
            {
                return false;
            }
        ...
        private bnet.protocol.notification.Variant MakeReadOnly()
        {
            return this;
        }

        public static bnet.protocol.notification.Variant ParseDelimitedFrom(Stream input)
        {
            return CreateBuilder().MergeDelimitedFrom(input).BuildParsed();
        }

        public static bnet.protocol.notification.Variant ParseDelimitedFrom(Stream input, ExtensionRegistry extensionRegistry)
        {
            return CreateBuilder().MergeDelimitedFrom(input, extensionRegistry).BuildParsed();
        }

        public static bnet.protocol.notification.Variant ParseFrom(byte[] data)
        {
            return CreateBuilder().MergeFrom(data).BuildParsed();
        }

        public static bnet.protocol.notification.Variant ParseFrom(ByteString data)
        {
            return CreateBuilder().MergeFrom(data).BuildParsed();
        }

        public static bnet.protocol.notification.Variant ParseFrom(ICodedInputStream input)
        {
            return CreateBuilder().MergeFrom(input).BuildParsed();
        }

        public static bnet.protocol.notification.Variant ParseFrom(Stream input)
        {
            return CreateBuilder().MergeFrom(input).BuildParsed();
        }

        public static bnet.protocol.notification.Variant ParseFrom(ByteString data, ExtensionRegistry extensionRegistry)
        {
            return CreateBuilder().MergeFrom(data, extensionRegistry).BuildParsed();
        }

        public static bnet.protocol.notification.Variant ParseFrom(ICodedInputStream input, ExtensionRegistry extensionRegistry)
        {
            return CreateBuilder().MergeFrom(input, extensionRegistry).BuildParsed();
        }

        public static bnet.protocol.notification.Variant ParseFrom(Stream input, ExtensionRegistry extensionRegistry)
        {
            return CreateBuilder().MergeFrom(input, extensionRegistry).BuildParsed();
        }

        public static bnet.protocol.notification.Variant ParseFrom(byte[] data, ExtensionRegistry extensionRegistry)
        {
            return CreateBuilder().MergeFrom(data, extensionRegistry).BuildParsed();
        }
        ...
        {
            GeneratedMessageLite<bnet.protocol.notification.Variant, Builder>.PrintField("bool_value", this.hasBoolValue, this.boolValue_, writer);
            GeneratedMessageLite<bnet.protocol.notification.Variant, Builder>.PrintField("int_value", this.hasIntValue, this.intValue_, writer);
            GeneratedMessageLite<bnet.protocol.notification.Variant, Builder>.PrintField("float_value", this.hasFloatValue, this.floatValue_, writer);
            GeneratedMessageLite<bnet.protocol.notification.Variant, Builder>.PrintField("string_value", this.hasStringValue, this.stringValue_, writer);
            GeneratedMessageLite<bnet.protocol.notification.Variant, Builder>.PrintField("blob_value", this.hasBlobValue, this.blobValue_, writer);
            GeneratedMessageLite<bnet.protocol.notification.Variant, Builder>.PrintField("message_value", this.hasMessageValue, this.messageValue_, writer);
            GeneratedMessageLite<bnet.protocol.notification.Variant, Builder>.PrintField("fourcc_value", this.hasFourccValue, this.fourccValue_, writer);
            GeneratedMessageLite<bnet.protocol.notification.Variant, Builder>.PrintField("uint_value", this.hasUintValue, this.uintValue_, writer);
            GeneratedMessageLite<bnet.protocol.notification.Variant, Builder>.PrintField("entityid_value", this.hasEntityidValue, this.entityidValue_, writer);
        }
        ...
        public static bnet.protocol.notification.Variant DefaultInstance
        {
            get
            {
        ...
        public override bnet.protocol.notification.Variant DefaultInstanceForType
        {
            get
            {
                return DefaultInstance;
        ...
        protected override bnet.protocol.notification.Variant ThisMessage
        {
            get
            {
                return this;
        ...
        public sealed class Builder : GeneratedBuilderLite<bnet.protocol.notification.Variant, bnet.protocol.notification.Variant.Builder>
        {
            private bnet.protocol.notification.Variant result;
            private bool resultIsReadOnly;

            public Builder()
            {
                this.result = bnet.protocol.notification.Variant.DefaultInstance;
                this.resultIsReadOnly = true;
            }

            internal Builder(bnet.protocol.notification.Variant cloneFrom)
            {
                this.result = cloneFrom;
                this.resultIsReadOnly = true;
            }

            public override bnet.protocol.notification.Variant BuildPartial()
            {
            ...
            public override bnet.protocol.notification.Variant.Builder Clear()
            {
                this.result = bnet.protocol.notification.Variant.DefaultInstance;
                this.resultIsReadOnly = true;
                return this;
            ...
            public bnet.protocol.notification.Variant.Builder ClearBlobValue()
            {
                this.PrepareBuilder();
            ...
            public bnet.protocol.notification.Variant.Builder ClearBoolValue()
            {
                this.PrepareBuilder();
            ...
            public bnet.protocol.notification.Variant.Builder ClearEntityidValue()
            {
                this.PrepareBuilder();
            ...
            public bnet.protocol.notification.Variant.Builder ClearFloatValue()
            {
                this.PrepareBuilder();
            ...
            public bnet.protocol.notification.Variant.Builder ClearFourccValue()
            {
                this.PrepareBuilder();
            ...
            public bnet.protocol.notification.Variant.Builder ClearIntValue()
            {
                this.PrepareBuilder();
            ...
            public bnet.protocol.notification.Variant.Builder ClearMessageValue()
            {
                this.PrepareBuilder();
            ...
            public bnet.protocol.notification.Variant.Builder ClearStringValue()
            {
                this.PrepareBuilder();
            ...
            public bnet.protocol.notification.Variant.Builder ClearUintValue()
            {
                this.PrepareBuilder();
            ...
            public override bnet.protocol.notification.Variant.Builder Clone()
            {
                if (this.resultIsReadOnly)
                {
                    return new bnet.protocol.notification.Variant.Builder(this.result);
                }
                return new bnet.protocol.notification.Variant.Builder().MergeFrom(this.result);
            }

            public bnet.protocol.notification.Variant.Builder MergeEntityidValue(EntityId value)
            {
            ...
            public override bnet.protocol.notification.Variant.Builder MergeFrom(bnet.protocol.notification.Variant other)
            {
                if (other != bnet.protocol.notification.Variant.DefaultInstance)
                {
                    this.PrepareBuilder();
            ...
            public override bnet.protocol.notification.Variant.Builder MergeFrom(ICodedInputStream input)
            {
                return this.MergeFrom(input, ExtensionRegistry.Empty);
            }

            public override bnet.protocol.notification.Variant.Builder MergeFrom(IMessageLite other)
            {
                if (other is bnet.protocol.notification.Variant)
                {
                    return this.MergeFrom((bnet.protocol.notification.Variant) other);
                }
                base.MergeFrom(other);
                return this;
            }

            public override bnet.protocol.notification.Variant.Builder MergeFrom(ICodedInputStream input, ExtensionRegistry extensionRegistry)
            {
                uint num;
                string str;
                this.PrepareBuilder();
                while (input.ReadTag(out num, out str))
                {
                    if ((num == 0) && (str != null))
                    {
                        int index = Array.BinarySearch<string>(bnet.protocol.notification.Variant._variantFieldNames, str, StringComparer.Ordinal);
                        if (index >= 0)
                        {
                            num = bnet.protocol.notification.Variant._variantFieldTags[index];
                        }
                        else
                        {
            ...
            private bnet.protocol.notification.Variant PrepareBuilder()
            {
                if (this.resultIsReadOnly)
                {
                    bnet.protocol.notification.Variant result = this.result;
                    this.result = new bnet.protocol.notification.Variant();
            ...
            public bnet.protocol.notification.Variant.Builder SetBlobValue(ByteString value)
            {
                Google.ProtocolBuffers.ThrowHelper.ThrowIfNull(value, "value");
                this.PrepareBuilder();
            ...
            public bnet.protocol.notification.Variant.Builder SetBoolValue(bool value)
            {
                this.PrepareBuilder();
            ...
            public bnet.protocol.notification.Variant.Builder SetEntityidValue(EntityId value)
            {
                Google.ProtocolBuffers.ThrowHelper.ThrowIfNull(value, "value");
                this.PrepareBuilder();
                this.result.hasEntityidValue = true;
            ...
            public bnet.protocol.notification.Variant.Builder SetEntityidValue(EntityId.Builder builderForValue)
            {
            ...
            public bnet.protocol.notification.Variant.Builder SetFloatValue(double value)
            {
                this.PrepareBuilder();
            ...
            public bnet.protocol.notification.Variant.Builder SetFourccValue(string value)
            {
                Google.ProtocolBuffers.ThrowHelper.ThrowIfNull(value, "value");
                this.PrepareBuilder();
            ...
            public bnet.protocol.notification.Variant.Builder SetIntValue(long value)
            {
                this.PrepareBuilder();
            ...
            public bnet.protocol.notification.Variant.Builder SetMessageValue(ByteString value)
            {
                Google.ProtocolBuffers.ThrowHelper.ThrowIfNull(value, "value");
                this.PrepareBuilder();
            ...
            public bnet.protocol.notification.Variant.Builder SetStringValue(string value)
            {
                Google.ProtocolBuffers.ThrowHelper.ThrowIfNull(value, "value");
                this.PrepareBuilder();
            ...
            [CLSCompliant(false)]
            public bnet.protocol.notification.Variant.Builder SetUintValue(ulong value)
            {
                this.PrepareBuilder();
            ...
            protected override bnet.protocol.notification.Variant MessageBeingBuilt
            {
                get
                {
            ...
            protected override bnet.protocol.notification.Variant.Builder ThisBuilder
            {
                get
                {
                    return this;
