namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.Animation), Tooltip("Enables/Disables an Animation on a GameObject.\nAnimation time is paused while disabled. Animation must also have a non zero weight to play.")]
    public class EnableAnimation : FsmStateAction
    {
        private AnimationState anim;
        [UIHint(UIHint.Animation), Tooltip("The name of the animation to enable/disable."), RequiredField]
