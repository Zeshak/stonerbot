namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Multiplies supplied values by 360 and rotates a GameObject by calculated amount over time."), ActionCategory("iTween")]
    public class iTweenRotateBy : iTweenFsmAction
    {
        ...
        [Tooltip("A vector that will multiply current GameObjects rotation."), RequiredField]
        ...
        private void DoiTween()
        {
            ...
            if (ownerDefaultTarget != null)
            {
                ...
                iTween.RotateBy(ownerDefaultTarget, iTween.Hash(args));
            }
        }
