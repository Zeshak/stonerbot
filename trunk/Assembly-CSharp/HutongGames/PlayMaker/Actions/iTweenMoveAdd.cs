namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Translates a GameObject's position over time."), ActionCategory("iTween")]
    public class iTweenMoveAdd : iTweenFsmAction
    {
        ...
        [ActionSection("LookAt"), Tooltip("For whether or not the GameObject will orient to its direction of travel. False by default.")]
        ...
        [Tooltip("A vector that will be added to a GameObjects position."), RequiredField]
        ...
        private void DoiTween()
        {
            ...
            if (ownerDefaultTarget != null)
            {
                ...
                iTween.MoveAdd(ownerDefaultTarget, args);
            }
        }
