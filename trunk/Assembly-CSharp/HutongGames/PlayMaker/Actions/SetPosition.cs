namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.Transform), Tooltip("Sets the Position of a Game Object. To leave any axis unchanged, set variable to 'None'.")]
    public class SetPosition : FsmStateAction
    {
        [Tooltip("Repeat every frame.")]
        public bool everyFrame;
        [Tooltip("The GameObject to position."), RequiredField]
        public FsmOwnerDefault gameObject;
        [Tooltip("Perform in LateUpdate. This is useful if you want to override the position of objects that are animated or otherwise positioned in Update.")]
        public bool lateUpdate;
        [Tooltip("Use local or world space.")]
        public Space space;
        [Tooltip("Use a stored Vector3 position, and/or set individual axis below."), UIHint(UIHint.Variable)]
