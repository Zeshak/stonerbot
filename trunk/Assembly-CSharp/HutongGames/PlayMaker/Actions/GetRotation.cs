namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Gets the Rotation of a Game Object and stores it in a Vector3 Variable or each Axis in a Float Variable"), ActionCategory(ActionCategory.Transform)]
