namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Get the values of multiple variables in another FSM and store in variables of the same name in this FSM."), ActionCategory(ActionCategory.StateMachine)]
