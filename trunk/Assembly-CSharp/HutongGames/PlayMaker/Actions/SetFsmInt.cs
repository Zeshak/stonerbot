namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.StateMachine), Tooltip("Set the value of an Integer Variable in another FSM.")]
    public class SetFsmInt : FsmStateAction
    {
        ...
        [RequiredField, UIHint(UIHint.FsmInt), Tooltip("The name of the FSM variable.")]
