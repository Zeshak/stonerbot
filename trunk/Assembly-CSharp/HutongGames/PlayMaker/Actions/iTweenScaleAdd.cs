namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Adds to a GameObject's scale over time."), ActionCategory("iTween")]
    public class iTweenScaleAdd : iTweenFsmAction
    {
        ...
        [RequiredField, Tooltip("A vector that will be added to the GameObjects scale.")]
        ...
        private void DoiTween()
        {
            ...
            if (ownerDefaultTarget != null)
            {
                ...
                iTween.ScaleAdd(ownerDefaultTarget, iTween.Hash(args));
            }
        }
