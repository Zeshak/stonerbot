namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.GUI), Tooltip("Rotates the GUI around a pivot point. By default only effects GUI rendered by this FSM, check Apply Globally to effect all GUI controls.")]
