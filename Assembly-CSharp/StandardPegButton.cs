...
public class StandardPegButton : PegUIElement
{
    ...
    public ThreeSliceElement m_grayFrame;
    public HighlightState m_highlight;
    public GameObject m_upBone;
    public ThreeSliceElement m_yellowFrame;
    ...
    {
        this.m_grayFrame.transform.localPosition = this.m_downBone.transform.localPosition;
    }

    protected override void OnRelease()
    {
        this.m_grayFrame.transform.localPosition = this.m_upBone.transform.localPosition;
        if (this.m_highlight != null)
        {
            this.m_highlight.ChangeState(ActorStateType.HIGHLIGHT_OFF);
        }
    ...
    {
        this.m_grayFrame.SetWidth(globalWidth * 0.88f);
        this.m_yellowFrame.SetWidth(globalWidth);
        Vector3 size = this.m_grayFrame.GetSize();
