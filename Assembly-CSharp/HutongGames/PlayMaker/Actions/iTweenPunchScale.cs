namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Applies a jolt of force to a GameObject's scale and wobbles it back to its initial scale."), ActionCategory("iTween")]
    public class iTweenPunchScale : iTweenFsmAction
    {
        ...
        private void DoiTween()
        {
            ...
            if (ownerDefaultTarget != null)
            {
                ...
                iTween.PunchScale(ownerDefaultTarget, iTween.Hash(args));
            }
        }
