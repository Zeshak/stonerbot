namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Randomly shakes a GameObject's rotation by a diminishing amount over time."), ActionCategory("iTween")]
    public class iTweenShakeRotation : iTweenFsmAction
    {
        ...
        [Tooltip("A vector shake range."), RequiredField]
        ...
        private void DoiTween()
        {
            ...
            if (ownerDefaultTarget != null)
            {
                ...
                iTween.ShakeRotation(ownerDefaultTarget, iTween.Hash(args));
            }
        }
